...
class Product(models.Model):
    ...
    desc_product=models.CharField(max_length=50)
    pieces=models.CharField(max_length=50)
    dimension=models.CharField(max_length=50)
    packing=models.CharField(max_length=50)
    actual_weight=models.CharField(max_length=50)
    charged_weight=models.CharField(max_length=50)
    prod_gst=models.CharField(max_length=50)
    prod_invoice=models.CharField(max_length=50)
